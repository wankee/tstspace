...
public class DeviceProvider extends ContentProvider {
    ...
    //static final Object DELock = new Object();
    
    //public static final String AUTHORITY = "com.refactech.provider";
    public static final String AUTHORITY = "com.refactech.device";
   ...
   // private static final int SHOTS = 0;
     ...
     */
    public static final String DEVICE_CONTENT_TYPE = "vnd.android.cursor.dir/vnd.refactech.device";
    ...
    private String matchTable(Uri uri) {
        ...
        switch (sUriMatcher.match(uri)) {
            case DEVICES:
                table = DevicesDataHelper.DevicesDBInfo.TABLE_NAME;
                break;
            default:
                throw new IllegalArgumentException("Unknown URI " + uri);
        }
    ...
    static class DBHelper extends SQLiteOpenHelper {
        // 数据库名
        private static final String DB_NAME = "driibo.device";
