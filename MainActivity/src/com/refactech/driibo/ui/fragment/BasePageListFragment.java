...
public abstract class BasePageListFragment<T> extends BaseFragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
       ...
       // System.out.println("on   basepagelist   fragment  on createview");
    ...
    protected void loadData(final int page) {
        ...
        //String url= "http://www.battlenet.com.cn/api/wow/auction/data/medivh";
       // String url= "www.baidu.com";
  	  System.out.println("loadData "+getUrl(page));
        executeRequest(new GsonRequest<T>(getUrl(page), getResponseDataClass(), null,
                new Response.Listener<T>() {
                    ...
                    public void onResponse(final T response) {
                        ...
                        CommonUtils.executeAsyncTask(new AsyncTask<Object, Object, Object>() {
                            ...
                            protected void onPostExecute(Object o) {
                          	  System.out.println("on onPostExecute");
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                    	System.out.println("on onErrorResponse");
    ...
    public void loadFirstPageAndScrollToTop() {
      //  System.out.println("on loadFirstPageAndScrollToTop");
        ListViewUtils.smoothScrollListViewToTop(mListView);
        loadFirstPage();
       // System.out.println("on loadFirstPageAndScrollToTop over");
    }
